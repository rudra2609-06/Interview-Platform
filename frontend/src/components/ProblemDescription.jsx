...
const ProblemDescription = ({
  ...
  return (
    <div className="overflow-visible w-full bg-base-200">
      {/* HEADER SECTION */}
      <div className="p-6 bg-base-100 border-b border-base-300">
        <div className="flex items-start justify-between mb-3">
          ...
          <span className={`badge ${difficultyLevelBadge(problem.difficulty)}`}>
            {problem.difficulty}
          </span>
        </div>
        ...
        <div className="mt-4">
          <select
            className="select select-sm w-full cursor-pointer select-ghost"
